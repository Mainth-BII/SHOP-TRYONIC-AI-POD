"""Build v29 Excel — Updated from v28 with 3 new feature sections."""
...
MD = os.path.join(BASE, "test_cases_suite_v29.md")
today = datetime.date.today().strftime("%Y-%m-%d")
OUTPUT = os.path.join(BASE, f"TC_POD-TShirt-Platform_ExecutionSummary_v29_final_{today}.xlsx")
VER = 29
...
cover_data = [
    ...
    ("Changes:", "v29: Sync source code. NEW: My Orders, Footer, Policy Pages. UPD: HOME AI Chat Hero, DS Sidebar (Thư Viện icon), StatusBar (pricing breakdown), Style Tags (vi-VN)"),
]
