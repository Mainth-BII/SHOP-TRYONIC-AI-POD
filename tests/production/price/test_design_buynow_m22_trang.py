"""
M22 Áo Phông Cơ Bản / Màu Trắng — Luồng In / Mua ngay (MH1→MH10)

Luồng: Listing → Detail → Studio (thiết kế mặt trước) → Review → Popup → Mua ngay → Checkout
       → QR → Order → Admin

Giá M22 / Trắng / Size M / qty 1:
  salePrice_áo  = 143.000đ
...
_SALE_AO      = _VARIANT["salePrice"]                           # 143_000
...
class TestDesignBuynowM22Trang(BasePriceFlowTest):
    """M22 Trắng — luồng In / Mua ngay MH1→MH10."""
    ...
    _REPORT_TITLE = "M22 Áo Phông Cơ Bản (Trắng) — In / Mua ngay"
    ...
    def setup(self, home_page, product_list_page, product_detail_page,
        ...
        self.tc       = "M22_TRANG_DESIGN_BUYNOW"
        self.root     = "production"
        self.domain   = "m22_trang_design_buynow"
        self._results = []
    ...
    def test_design_buynow(self):
        """M22 Trắng / In / Mua ngay — MH1→MH10."""
        tc = self.tc
        self._login()
