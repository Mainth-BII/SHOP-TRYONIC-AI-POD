"""
PT01 Áo Phông Cá Tính / Màu Đen — Luồng In / Mua ngay (MH1→MH10)

Luồng: Listing → Detail → Studio (thiết kế mặt trước) → Review → Popup → Mua ngay → Checkout
       → QR → Order → Admin

Màu Đen thay vì Trắng — cùng variant M/L/XL, cùng salePrice=189.000đ

Giá PT01 / Đen / Size M / qty 1:
...
class TestDesignBuynowPT01Den(BasePriceFlowTest):
    """PT01 Đen — luồng In / Mua ngay MH1→MH10."""
    ...
    _REPORT_TITLE = "PT01 Áo Phông Cá Tính (Đen) — In / Mua ngay"
    ...
    def setup(self, home_page, product_list_page, product_detail_page,
        ...
        self.tc       = "PT01_DEN_DESIGN_BUYNOW"
        self.root     = "production"
        self.domain   = "pt01_den_design_buynow"
        self._results = []
    ...
    def test_design_buynow(self):
        ...
        self._assert_price(sale_disp, _SALE_AO, "MH2 Giá sale default (Đen)")
