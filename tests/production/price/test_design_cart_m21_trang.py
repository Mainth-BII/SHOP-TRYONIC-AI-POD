"""
M21 Trắng — Full flow: Listing → Detail → Studio → Review (đổi công nghệ in) → Popup Mua ngay → Cart → Checkout / Mã USERMAI
...
_SALE_TRANG   = _V_TRANG["salePrice"]        # 130_000
_COST_TRANG   = _V_TRANG["costPrice"]        # 60_000

_SALE_MAU     = _V_MAU["salePrice"]          # 139_000
_COST_MAU     = _V_MAU["costPrice"]          # 64_000
...
class TestDesignCartM21Trang(BasePriceFlowTest):
    """M21 Trắng / Studio / Cart / USERMAI — full flow."""
    ...
    _REPORT_TITLE = "M21 Áo Phông Năng Động (Trắng / Studio / Cart / USERMAI)"
    TOLERANCE = 2_000
    ...
    def setup(self, home_page, product_list_page, product_detail_page,
        ...
        self.tc       = "M21_TRANG_STUDIO_CART"
        self.root     = "production"
        self.domain   = "m21_trang_studio_cart_flow"
        self._results = []
    ...
    def test_m21_trang_studio_cart_flow(self):
        tc = self.tc
        self._login()
        ...
        # Chọn lại màu Trắng để vào Studio
        ...
        ao_total = review_data.get("ao_total", _SALE_MAU)   # Đen dùng M21_MAU
        ...
        # Review page có thể hiển thị giá Trắng (130k+91k=221k) dù đang dùng Đen.
        # Tổng vẫn đúng (221k), nhưng cần điều chỉnh ao/print breakdown cho USERMAI.
