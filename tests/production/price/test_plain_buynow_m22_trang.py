"""
M22 Áo Phông Cơ Bản / Màu Trắng — Luồng Trơn / Mua ngay (MH1→MH10)
...
class TestPlainBuynowM22Trang(BasePriceFlowTest):
    """M22 Trắng — luồng Trơn / Mua ngay MH1→MH10."""
    ...
    _REPORT_TITLE = "M22 Áo Phông Cơ Bản (Trắng) — Trơn / Mua ngay"
    ...
    def setup(self, home_page, product_list_page, product_detail_page,
        ...
        self.tc       = "M22_TRANG_PLAIN_BUYNOW"
        self.root     = "production"
        self.domain   = "m22_trang_plain_buynow"
        self._results = []

    @pytest.mark.production
    def test_plain_buynow(self):
        """M22 Trắng / Trơn / Mua ngay — MH1→MH10."""
        tc = self.tc
        self._login()
