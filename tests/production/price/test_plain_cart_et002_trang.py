"""
ET002 Áo Phông Trẻ Em / Màu Trắng — Luồng Trơn / Giỏ hàng (MH1→MH11)
...
class TestPlainCartET002Trang(BasePriceFlowTest):
    """ET002 Trắng — luồng Trơn / Giỏ hàng MH1→MH11."""
    ...
    _REPORT_TITLE = "ET002 Áo Phông Trẻ Em (Trắng) — Trơn / Giỏ hàng"
    ...
    def setup(self, home_page, product_list_page, product_detail_page,
        ...
        self.tc       = "ET002_TRANG_PLAIN_CART"
        self.root     = "production"
        self.domain   = "et002_trang_plain_cart"
        self._results = []
    ...
    def test_plain_cart(self):
        """ET002 Trắng / Trơn / Giỏ hàng — MH1→MH11."""
        tc = self.tc
        self._login()
