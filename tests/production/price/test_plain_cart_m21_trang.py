"""
M21 Áo Phông Năng Động / Màu Trắng — Luồng Trơn / Giỏ hàng (MH1→MH11)
...
class TestPlainCartM21Trang(BasePriceFlowTest):
    """M21 Trắng — luồng Trơn / Giỏ hàng MH1→MH11."""
    ...
    _REPORT_TITLE = "M21 Áo Phông Năng Động (Trắng) — Trơn / Giỏ hàng"
    ...
    def setup(self, home_page, product_list_page, product_detail_page,
        ...
        self.tc       = "M21_TRANG_PLAIN_CART"
        self.root     = "production"
        self.domain   = "m21_trang_plain_cart"
        self._results = []
    ...
    def test_plain_cart(self):
        """M21 Trắng / Trơn / Giỏ hàng — MH1→MH11."""
        tc = self.tc
        self._login()
